...
(why do we only plot y vs age/balance? what about other numerical variables?)
...
# (here we just want to make sure svm performs equally well on training/testing set. Only the confusion matrix on testing set needs to go in final report)

# training data; svm linear
svm.pred.lin <- predict(best.linear)
...
svm.pred.radial <- predict(best.radial, x)
