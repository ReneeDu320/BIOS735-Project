...
```
The following plots show some insights from the priginal dataset. People aged from 25-50 are more considered as potential customers since the density for this age group is especially high in the plot.
